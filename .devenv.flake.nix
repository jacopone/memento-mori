{
  inputs =
    let
      version = "1.9.0";
system = "x86_64-linux";
devenv_root = "/home/guyfawkes/nixos-config/templates/ai-quality-devenv";
devenv_dotfile = "/home/guyfawkes/nixos-config/templates/ai-quality-devenv/.devenv.uDSg9n";
devenv_dotfile_path = ./.devenv.uDSg9n;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-ecee547";
